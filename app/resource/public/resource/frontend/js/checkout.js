    ...
    var app={
        ...
        addAddress:function(){
            ...
            $("#addAddress").click(function () {
				...
				$.post('/user/address/add', { "name": name, "phone": phone, "address": address, "zipcode": zipcode }, function (response) {
        ...
        changeDefaultAddress:function(){          
            ...
            $("#addressList").on("click",".J_addressItem",function(){
                ...
                $.post('/user/address/changeDefault?address_id='+id,function(response){})
            })
        },
        editAddress:function(){
            ...
            $("#addressList").on("click",".modify",function(e){
                ...
                $.get('/user/address/getOne?address_id='+id,function(response){
					console.log(response)
                    if(response.success){
                        var addressInfo=response.data.result;
        ...
        goEditAddress:function(){
            $("#goEditAddress").click(function(){
                ...
                $.post('/user/address/edit',{"id":id,"name":name,"phone":phone,"address":address,"zipcode":zipcode},function(response){
